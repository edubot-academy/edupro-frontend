...
function HeroBanner() {
  ...
  return (
    <div className="bg-gradient-to-t -mt-22 from-[#EBE2FF] to-[#E7E7E7] overflow-hidden">
      <div className="relative w-full h-auto lg:h-screen flex flex-col items-center justify-center lg:justify-start mb-10 px-6 md:px-10 font-[Unbounded]">
        <h1 className="absolute -top-8 md:top-16 text-[14rem] md:text-[250px] lg:text-[320px] font-bold bg-gradient-to-t from-[#190B3B] to-[#A37FFF] bg-clip-text text-transparent opacity-15 select-none leading-none text-center lg:text-left">
          Edu
      ...
      <div className="relative z-20 -mt-5 md:-mt-48 lg:-mt-80 lg:backdrop-blur-lg lg:shadow-2xl md:backdrop-blur-lg md:shadow-2xl font-[Suisse Intl]">
        <div className="flex flex-col lg:flex-row md:flex-row justify-between items-center lg:items-start md:items-start md:border-t-[2px] border-white">
          <div className="max-w-sm md:max-w-lg lg:max-w-xl lg:px-20 lg:pt-14 p-6 md:-mt-6 md:mb-10 md:p-8 text-center lg:text-left">
            <p className="text-[#2C2C2C] text-sm md:text-base text-left h-24  md:text-left md:w-96">
        ...
        <div className="relative w-full lg:block md:block">
          <img
            src={bg}
            className="hidden md:block lg:block relative md:-mt-56 lg:-mt-72"
            alt=""
          />
          <div
            className="absolute z-20 top-0 lg:right-10 p-6 md:p-10 lg:pr-36 md:right-0 md:-mr-16  md:py-4 lg:py-14 bg-white w-full md:w-auto md:bg-transparent relative md:absolute pl-16 mt-4 md:mt-0 "
          >
          ...
          <div className="lg:absolute bg-white lg:bottom-44 z-30 ">
            <Metrics />
          </div>
