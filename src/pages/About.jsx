...
export default function About() {
  const values = [
    {
      title: "Student-First",
      text: "We design every lesson, project, and review around real learning outcomes.",
    },
    {
      title: "Practice > Theory",
      text: "Short lessons, real projects, feedback loops, and portfolio-first delivery.",
    },
    {
      title: "Career Focused",
      text: "Resume, LinkedIn, mock interviews, referrals, and soft-skill coaching.",
    },
    {
      title: "Community",
      text: "Mentors, alumni, and hiring partners who support you beyond graduation.",
    },
  ];

  const mentors = [
    {
      name: "Bekten Orunbaev",
      role: "Founder • Frontend",
      bio: "React, Vite, Tailwind, product mentoring.",
      img: "",
    },
    {
      name: "Backend Mentor",
      role: "Django/Python",
      bio: "APIs, Postgres, Docker, CI/CD.",
      img: "",
    },
    {
      name: "Mobile Mentor",
      role: "Flutter",
      bio: "Dart, state mgmt, publishing apps.",
      img: "",
    },
    {
      name: "UX/UI Mentor",
      role: "Design",
      bio: "Figma, research, design systems.",
      img: "",
    },
  ];
  ...
  const timeline = [
    {
      date: "2024",
      title: "Idea → Pilot",
      text: "Validated curriculum with first cohort.",
    },
    {
      date: "2025 Q1",
      title: "EduPro Academy brand",
      text: "Launched public programs in KG/RU/EN.",
    },
    {
      date: "2025 Q2",
      title: "CRM MVP",
      text: "Lead pipeline, admissions workflow.",
    },
    {
      date: "2025 Q4",
      title: "LMS MVP",
      text: "Student portal, progress, quizzes, HLS video.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {partners.map((p, i) => (
              <div
                key={i}
                className="rounded-xl bg-white ring-1 ring-slate-200 p-4 text-center"
              >
      ...
      <section className="py-16 bg-gradient-to-br from-emerald-50 to-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-600 mt-2">
            Apply in 3 minutes. We’ll follow up within 24 hours.
          </p>
          <div className="mt-6 flex justify-center gap-3">
            ...
            <Link
              to="/programs"
              className="px-6 py-3 rounded-xl border border-slate-300 font-semibold hover:bg-white"
            >
              See Programs
            </Link>
          </div>
